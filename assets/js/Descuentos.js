(function() {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const descuentoID = urlParams.get('id');
        //Mostrar recompensaID en el input RecompensaID
        const inputDescuentoID = document.getElementById("DescuentoID");
        if (inputDescuentoID) {
            inputDescuentoID.value = descuentoID;
        }
    ...
    //Funcion para listarDescuentos
    function listarDescuentos() {
        fetch(URL_BASE + 'listarDescuentos', {
        ...
        .then(result => {
            ...
            if ($.fn.DataTable.isDataTable('#descuentosTable')) {
                $('#descuentosTable').DataTable().destroy();
            }
                    ...
                    { data: 'UsuarioID' },  
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            let activarODesactivar = row.Estado === 'Activo' 
                                ? `<button class="btn Desactivar" data-id="${row.DescuentoID}">
                                        <i class="fas fa-user-slash"></i> Desactivar
                                    </button>`
                                : `<button class="btn Activar" data-id="${row.DescuentoID}">
                            ...
                            return `
                                <div class="action-buttons">
                                    ...
                                    <a href="updateDescuento.html?id=${row.DescuentoID}" class="edit"><i class="fas fa-edit"></i> Editar</a>
                                    <button class="btn delete" data-id="${row.DescuentoID}">
